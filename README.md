...
[![CircleCI](https://circleci.com/gh/moneystreamhq/web-monetization-projects.svg?style=svg)](https://circleci.com/gh/moneystreamhq/web-monetization-projects)
[![Dependabot Status](https://api.dependabot.com/badges/status?host=github&repo=moneystreamhq/web-monetization-projects)](https://dependabot.com)
...
- **do not assume master branch is in a good state** !
  - Go through the release [release checklist](packages/moneystream-extension/docs/release-checklist.md) carefully!
...
```sh
git clone git@github.com:moneystreamhq/web-monetization-projects.git
yarn
```
...
See the [moneystream-monorepo-upkeep](packages/moneystream-monorepo-upkeep) folder for details
...
For example, check the moneystream-extension [tsconfig.build.json](./packages/moneystream-extension/tsconfig.build.json)
