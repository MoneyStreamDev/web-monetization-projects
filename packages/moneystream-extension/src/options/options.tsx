...
const totals: Array<PageTotal> = [
  ...
  },
  {
    ...
    favIcon: 'https://cdn.moneystream.com/assets/favicon.png',
    total: parseAmount('$0.42'),
    key: makeKey(
      'https://moneystream.com/p/WannaWanga/Kennedy-Family-Recipes/SlVNM7isL',
      '$spsp.moneystream.com/moneystream-content/creator'
    )
  },
  {
    ...
    key: makeKey(
      'https://moneystream.com/p/Robert_Palmer/Darts-and-Laser-Focus/EOvsWVSAl',
      '$spsp.moneystream.com/moneystream-content/creator'
    )
  }
]
