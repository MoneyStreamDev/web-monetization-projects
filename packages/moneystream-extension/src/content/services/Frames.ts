...
export class Frames {
  isTopFrame: boolean
  isAnyMoneystreamFrame: boolean
  isIFrame: boolean
  isMoneystreamTopFrame: boolean
  isMoneystreamHandlerFrame: boolean
  ...
  constructor(
    ...
    @inject(tokens.MoneystreamDomain) private moneystreamDomain: string
  ) {
    this.isTopFrame = window === window.top
    this.isAnyMoneystreamFrame = window.origin === moneystreamDomain
    this.isIFrame = !this.isTopFrame
    this.isMoneystreamTopFrame = this.isTopFrame && this.isAnyMoneystreamFrame
    // injected into background page in an <iframe>
    this.isMoneystreamHandlerFrame =
      this.isAnyMoneystreamFrame &&
      !this.isTopFrame &&
    ...
    // without `tab`)
    this.isMonetizableFrame = !this.isMoneystreamHandlerFrame
  }
