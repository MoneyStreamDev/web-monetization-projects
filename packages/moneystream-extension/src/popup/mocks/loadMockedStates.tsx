...
const payingMoneystreamArticle = mockState({
  monetized: true,
  moneystreamSite:
    'https://moneystream.com/p/mirrae/Letter-to-my-Daughter/-ZInTJqN-',
...
const startExploring = mockState({
  moneystreamSite: 'https://moneystream.com/explore',
  monetizedTotal: 0,
  monetizedFavicon: '/res/icon-page.svg',
  user: user,
  validToken: true,
...
const payingNonMoneystreamSite = mockState({
  monetized: true,
...
const welcomeToMoneystream = mockState({
  moneystreamSite: 'https://moneystream.com/',
  monetizedTotal: 0,
  monetizedFavicon: '/res/icon-page.svg',
  user: user,
  validToken: true,
...
const MOCK_STATES = [
  { name: 'Paying Moneystream Article', state: payingMoneystreamArticle },
