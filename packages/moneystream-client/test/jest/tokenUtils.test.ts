import {
  MoneystreamTokenUtils,
  DecodedToken,
  decodeToken
} from '@moneystream/client'
 ...
 */
class TestTokenUtils extends MoneystreamTokenUtils {
...
describe('MoneystreamTokenUtils', () => {
  ...
  describe('MoneystreamTokenUtils#isExpired', () => {
  ...
  describe('MoneystreamTokenUtils#newestToken', () => {
    const utils = new TestTokenUtils()
